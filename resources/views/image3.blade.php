    ...
    <body class="bg-light">
        ...
        <div class="container-md my-5">
            <div class="col-xxl-5 col-xl-6 col-lg-8 mx-auto">
                <h1 class="h1 fw-bold mb-5">Novo Post</h1>
                ...
                <form class="dropzone overflow-visible p-0" id="formDropzone" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label text-muted opacity-75 fw-medium" for="content">Conteúdo</label>
                        <textarea class="form-control border-2 shadow-none fw-bold p-3" id="content" name="content" required></textarea>
                        <div class="invalid-feedback fw-bold">Campo Obrigatório</div>
                    </div>
